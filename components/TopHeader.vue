...
<template>
  ...
  <div class="bg-white text-gray-100 text-sm py-2.5 border-b border-gray-800">
    <div class="container mx-auto px-4 flex items-center justify-between">
      ...
      <div class="flex items-center space-x-8">
        <div class="flex items-center gap-2 hover:text-blue-400 transition-colors group">
          ...
          <span>Hotline: <span class="font-medium text-gray-900">09613 787878</span></span>
        </div>

        <div class="flex items-center gap-2 hover:text-blue-400 transition-colors group">
          <Icon name="mdi:map-marker-outline" class="text-lg text-primary group-hover:scale-110 transition-transform" />
          <span>Showroom: <span class="font-medium text-gray-900">Gulshan-1, Dhaka</span></span>
        </div>

        <div class="flex items-center gap-2 hover:text-blue-400 transition-colors group">
          <Icon name="mdi:clock-outline" class="text-lg text-primary group-hover:scale-110 transition-transform" />
          <span>Working Hours: <span class="font-medium text-gray-900">9AM - 11PM</span></span>
        </div>
      </div>
